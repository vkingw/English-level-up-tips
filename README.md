...
| 第二部：把自己放回生活 | 能力、事业、关系、失败与恢复怎样互相影响？ | [我的故事](docs/threads/part-2/my-story.md) · [恢复篇](docs/threads/part-2/recovery.md) |
...
[我的故事](docs/threads/part-2/my-story.md)、[恢复篇](docs/threads/part-2/recovery.md)、[创业篇](docs/threads/part-2/entrepreneurship.md)和[旧文归档](docs/threads/archive/README.md)保留了失败、身体失序、关系变化、离开与重返。回望不是为了把过去装饰成励志故事，而是为了辨认：哪些决定有效，哪些代价不能忽略，下一次怎样活得更诚实。
