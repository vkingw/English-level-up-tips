...
<div class="guide-paths">
  <a class="guide-path" href="./threads/part-1/0-cefr"><strong>英语学习系统</strong>从 CEFR 自测到词汇、听说读写和 12 周训练。</a>
...
1. 用 [英语能力诊断](templates/english-diagnostic.md) 或自己的真实任务确定起点。
2. 把目标、证据和下一步写进 [学习状态](templates/learning-state.md)。
3. 只选一个 25–45 分钟任务，完成可检查的输出，而不是继续收集资料。
4. 一周后用 [每周复盘](templates/weekly-review.md) 看证据，再调整难度与频率。

## 英语学习系统

先读 [CEFR 目标与自测](threads/part-1/0-cefr.md)，用“我能完成什么任务”而不是模糊的词汇量或考试印象判断水平。

| 环节 | 章节 | 本轮应留下的证据 |
| --- | --- | --- |
| 校准 | [认知篇](threads/part-1/1-understanding.md) | 一个具体场景、基线样本和 12 周目标 |
| 词汇 | [词汇篇](threads/part-1/2-vocabulary.md) | 20 个能听懂、读懂并在句子中使用的词块 |
| 听力 | [听力篇](threads/part-1/3-listening.md) | 一段听写、复述和错误分类 |
| 阅读 | [阅读篇](threads/part-1/4-reading.md) | 一页批注、五句摘要和一个迁移问题 |
| 口语 | [口语篇](threads/part-1/5-speaking.md) | 录音、转写和第二版重录 |
| 写作 | [写作篇](threads/part-1/6-writing.md) | 初稿、反馈清单和修订稿 |
| AI | [用 AI 学英语](threads/part-1/7-ai.md) | 可复用提示词、错题记录和学习状态更新 |

词表只是查阅材料，不是学习目标。需要时可进入 [通用词表](threads/word-list/Common.md) 与各技术主题词表。

## AI 学习与工作能力

[使用 AI 学习一切](threads/part-3/1-ai-learning.md)采用按任务选择的工作流：
...
个人故事被保留，是因为成长从来不只发生在学习计划里。你可以阅读 [我的故事](threads/part-2/my-story.md)、[创业篇](threads/part-2/entrepreneurship.md) 和 [旧文归档](threads/archive/README.md)。这些内容是作者的经历，不是医疗、法律、投资或创业建议。
...
如果今天只做一件事：创建一份 [学习状态](templates/learning-state.md)，写下当前证据和下一步，然后完成其中最小的一项。
