...
2. 在 [学习状态](templates/learning-state.md) 中写下当前基线：已经知道什么、还不会什么、什么结果算完成；遇到选择、注意力、关系或恢复问题时，使用[生活进阶工作表](templates/life-practice-toolkit.md)。
