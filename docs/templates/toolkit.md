...
不要同时填写全部模板。按下面的顺序，每一步只留下最必要的一份证据：
...
相关入口：[阅读指南：把书放回生活](../threads/part-0/reader-guide.md) ｜ [术语与方法索引](../reference/glossary.md) ｜ [节律篇：让小事穿过时间](../threads/part-4/rhythm-and-compounding.md)
