...
- 区分听力/阅读中的接受性词汇与口语/写作中的产出性词汇；
- 从真实任务筛选高价值词块，而不是用总量证明进步；
- 通过主动回忆、搭配、真实语境和动态间隔把“眼熟”变成可使用；
- 用词汇审计和延迟迁移检查一周后是否仍能理解和产出。
...
本目录的词表是查阅索引，不是每天必须完成的数量目标。打开一个真实任务，先从下面最接近的列表中挑 5–8 个词块，再回到现行文档、代码或会议材料核对含义和语域：

| 词表 | 适合的任务入口 |
| --- | --- |
| [Common](../word-list/Common.md) | 日常沟通、通用工作和跨主题表达 |
| [Prompt](../word-list/Prompt.md) | AI 任务说明、限制条件和验收句式 |
| [Vibe Coding](../word-list/VibeCoding.md) | AI 辅助开发、代理协作和代码审查 |
| [JavaScript](../word-list/JavaScript.md) | 前端脚本、浏览器 API 和异步流程 |
| [Python](../word-list/Python.md) | 数据处理、自动化和脚本任务 |
| [Go](../word-list/Go.md) | 服务端、并发和部署语境 |
| [Java](../word-list/Java.md) | JVM 项目、类型和企业系统语境 |
| [PHP](../word-list/PHP.md) | Web 后端、模板和旧系统维护 |
| [Rust](../word-list/Rust.md) | 所有权、性能和系统编程语境 |
| [Swift](../word-list/Swift.md) | Apple 平台、界面和应用开发 |

每个词表都应经过同一条小回路：从当前任务选词，查声音、搭配、版本和来源；脱离列表说或写一个新句子；一周后在平行任务里复测。词表里的术语可能随语言版本、框架和产品更新而变化，关键决定必须回到官方文档，不要把列表本身当作技术标准。
...
如果你不确定自己究竟卡在哪一层，可以使用[词汇审计模板](../../templates/vocabulary-audit.md)，把听辨、阅读、口语、写作和延迟迁移分开记录。
