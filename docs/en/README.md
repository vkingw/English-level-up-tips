...
Use [CEFR Goals and Self-check](threads/part-1/0-cefr.md) to establish a real baseline, then enter [Learning Principles](threads/part-1/1-understanding.md), [Vocabulary](threads/part-1/2-vocabulary.md), [Listening](threads/part-1/3-listening.md), [Reading](threads/part-1/4-reading.md), [Speaking](threads/part-1/5-speaking.md), [Writing](threads/part-1/6-writing.md), or [Learning English with AI](threads/part-1/7-ai.md) as the task requires. You can also begin directly with the [English Diagnostic](templates/english-diagnostic.md) or [Vocabulary Audit](templates/vocabulary-audit.md).
