...
| Part II: Return to Life | How do ability, work, relationships, failure, choices, and recovery affect one another? | [My Story](threads/part-4/my-story.md) · [Decision-Making](threads/part-2/decision.md) · [Recovery](threads/part-2/recovery.md) |
