...
| Part I: Open Input | How do I build a bridge between English and the world? | [Part Introduction](threads/part-1/open-input.md) · [CEFR Self-check](threads/part-1/0-cefr.md) · [Vocabulary, Listening, Reading, Speaking, Writing](threads/part-1/2-vocabulary.md) |
...
| Part V: Long-Term Action | How can I make change verifiable in 90 days? | [Part Introduction](threads/part-5/long-term-action.md) · [90-Day Action Plan](threads/part-5/90-day-plan.md) |
