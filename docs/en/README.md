...
| Part I: Open Input | How do I build a bridge between English and the world, then carry ability into interviews and remote collaboration? | [Part Introduction](threads/part-1/open-input.md) · [CEFR Self-check](threads/part-1/0-cefr.md) · [Vocabulary, Listening, Reading, Speaking, Writing](threads/part-1/2-vocabulary.md) · [Job-search English](threads/part-1/8-job-search-english.md) |
