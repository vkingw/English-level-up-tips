...
- How can a first week leave a baseline, feedback, delayed retest, and transfer instead of only a streak?
- How can full, compressed, and recovery days carry different weights?
