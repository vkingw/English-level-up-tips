...
That is why this guide repeatedly asks you to preserve the [AI Task Brief](../../templates/ai-task-brief.md), [Artifact Brief and Delivery Card](../../templates/artifact-brief.md), and [Learning State](../../templates/learning-state.md). They are not paperwork. They keep the human gate and responsibility boundary visible.
...
Link this page to the [Weekly Review](../../templates/weekly-review.md) and the [90-Day Cycle Map](../../templates/90-day-cycle.md). At the end of a cycle, place it beside the first sample. Keep the version that was wrong, not only the sentence that summarises it.
